...
/** 名前編集モードのフラグ */
export const isEditSvgName = ref(false)

/** ピン挿入モード、マーカー挿入モードまたはスクロールモードのときtrueを返す。 */
export const isAnyMode = computed(() => {
...
export const editSvgName = (svg: Rect | Polyline) => {
...
export const updateSvgName = (e: KeyboardEvent, svg: Rect | Polyline) => {
